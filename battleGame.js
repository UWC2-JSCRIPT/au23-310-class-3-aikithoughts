...
//   const minDamageInclusive = Math.floor(0);
//   const maxDamageInclusive = Math.ceil(variableDamage);
//   const randomDamage = Math.floor(Math.random() * (maxDamageInclusive - minDamageInclusive + 1) + minDamageInclusive);
